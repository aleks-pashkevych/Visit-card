...
const dev = gulp.series(deleteFile, mainTasks, gulp.parallel(watcher, server));
const build = gulp.series(deleteFile, mainTasks);
const deployZIP = gulp.series(deleteFile, mainTasks, zip);
const deployFTP = gulp.series(deleteFile, mainTasks, ftp);
